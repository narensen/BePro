...
export default function Explore() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-deep-navy via-warm-beige to-cool-teal">
        <SideBar />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-deep-navy via-warm-beige to-cool-teal font-mono relative">
      <SideBar />
