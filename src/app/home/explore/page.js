...
export default function Explore() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-amber-400 to-orange-400">
        <SideBar />
        <div className="pt-16 lg:pt-0 desktop:ml-72">
          <LoadingSpinner />
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-amber-400 to-orange-400 font-mono relative">
      ...
      <div className="min-h-screen pb-20 pt-16 lg:pt-0 lg:pb-0 desktop:ml-72 xl:mr-80">
        <div className="container-mobile mobile:px-3 px-3 lg:px-6 mobile:py-3 py-4 lg:py-6 min-h-screen flex items-center justify-center">
