...
export default function LandingPage() {
  ...
  return (
    ...
    <main className="relative bg-gradient-to-br from-deep-navy via-warm-beige to-cool-teal text-deep-navy overflow-x-hidden font-mono">
      {}
      <div 
      ...
      <FloatingElement delay={0} className="absolute top-16 left-4 md:top-20 md:left-10 opacity-20">
        <Code2 className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 text-deep-navy" />
      </FloatingElement>
      <FloatingElement delay={2} className="absolute top-40 right-4 md:right-20 opacity-20">
        <Brain className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-muted-terracotta" />
      </FloatingElement>
      <FloatingElement delay={4} className="absolute bottom-40 left-4 md:left-20 opacity-20">
        <Target className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 text-cool-teal" />
      </FloatingElement>
      ...
      {}
      <AnimatedSection className="py-20 sm:py-24 md:py-32 px-4 sm:px-6" background="bg-warm-beige/10 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto">
          {}
          <div className="text-center mb-12 md:mb-20">
            {}
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 md:mb-8 text-deep-navy">Meet Your <span className="text-muted-terracotta">AI Mentor</span></h2>
            <p className="max-w-4xl mx-auto text-lg sm:text-xl md:text-2xl text-deep-navy/80 leading-relaxed font-bold">
      ...
      <AnimatedSection className="py-20 sm:py-24 md:py-32 px-4 sm:px-6" background="backdrop-blur-xl">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 md:mb-8 text-deep-navy">The Illusion of Progress</h2>
          <p className="max-w-4xl mx-auto text-lg sm:text-xl md:text-2xl text-muted-terracotta leading-relaxed font-bold">
      ...
      <AnimatedSection id="codex" className="py-20 sm:py-24 md:py-32 px-4 sm:px-6" background="bg-warm-beige/10 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 md:mb-8 text-deep-navy">The <span className="text-muted-terracotta">Codex</span>: Your AI Mentor</h2>
            <p className="max-w-4xl mx-auto text-lg sm:text-xl md:text-2xl text-deep-navy/80 leading-relaxed font-bold">
      ...
      <AnimatedSection id="fortress" className="py-20 sm:py-24 md:py-32 px-4 sm:px-6" background="backdrop-blur-xl">
        <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 md:mb-20">
                <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 md:mb-8 text-deep-navy">The <span className="text-muted-terracotta">Community Fortress</span></h2>
                <p className="max-w-4xl mx-auto text-lg sm:text-xl md:text-2xl text-cool-teal leading-relaxed font-bold">
      ...
      <AnimatedSection id="philosophy" className="py-20 sm:py-24 md:py-32 px-4 sm:px-6" background="bg-warm-beige/10 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-8 md:mb-12 text-deep-navy">This Is Not For Everyone.</h2>
          <p className="max-w-4xl mx-auto text-lg sm:text-xl md:text-2xl text-deep-navy/80 leading-relaxed font-bold">
            We are not for the casual learner; we are for the <span className="text-muted-terracotta">obsessed builder</span>. We are not for the 95% who seek comfort; we are for the <span className="text-cool-teal">5% who seek the throne</span>.
          </p>
        </div>
      </AnimatedSection>
