  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative pt-20 px-4 sm:px-6">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto w-full">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-6 sm:mb-8 leading-tight transition-opacity duration-500 ease-in-out">
          <span className="text-gray-900 animate-fade-in-down block sm:inline">
            {headlineCombos[headlineIndex].top}
          </span>
          <br className="hidden sm:block" />
          <span className="text-white animate-fade-in-up block sm:inline">
        ...
        <p
          key={lineIndex}
          className="max-w-4xl mx-auto text-lg sm:text-xl md:text-2xl text-gray-800 mb-8 sm:mb-12 leading-relaxed font-bold px-4 animate-fade-in-up transition-opacity duration-500 ease-in-out"
        ...
        <div
          className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center animate-fade-in-up px-4"
