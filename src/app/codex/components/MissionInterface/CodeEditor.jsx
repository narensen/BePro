    ...
    <div className="border-t border-gray-200 bg-gray-50/95 backdrop-blur-sm p-4 lg:p-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          <div className="p-2 bg-gradient-to-r from-gray-200 to-gray-600 rounded-lg">
      ...
      <textarea
        ...
        className="w-full h-40 bg-gray-900 text-green-400 font-mono text-sm p-4 rounded-xl border border-gray-300 focus:border-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-500/20 resize-none shadow-inner"
      ...
      <div className="flex justify-end mt-4 space-x-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-gray-200 to-gray-600 hover:from-gray-300 hover:to-gray-700 text-gray-900 text-sm rounded-lg transition-all duration-300 hover:scale-105 font-bold shadow-lg"
        >
          <Code size={14} />
          Send to Chat
        </button>
