    ...
    >
      {quickPrompts.map((prompt, idx) => (
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full text-left rounded-lg px-4 py-2 bg-gradient-to-r from-yellow-100 to-yellow-100 text-amber-900 font-mono font-semibold shadow hover:bg-amber-100 transition"
