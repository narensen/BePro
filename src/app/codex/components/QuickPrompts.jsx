    ...
    >
      {quickPrompts.map((prompt, idx) => (
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full text-left text-center rounded-lg px-3 lg:px-4 py-3 lg:py-4 bg-gradient-to-r from-gray-100 to-gray-100 text-gray-900 font-mono font-semibold shadow hover:bg-gray-100 transition text-sm lg:text-base lg:text-center leading-tight"
