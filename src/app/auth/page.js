  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-yellow-400 via-amber-400 to-orange-400 text-gray-900 font-sans flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <button
        ...
        className="absolute top-4 sm:top-6 left-4 sm:left-6 bg-gray-900 text-amber-300 px-3 sm:px-5 py-2 sm:py-3 rounded-xl font-bold shadow-lg hover:bg-gray-800 hover:scale-105 transition-all duration-300 cursor-pointer z-20 text-sm sm:text-base"
      >
        ← Back to Home
      </button>
        ...
        <div className="bg-white/95 backdrop-blur-sm p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-200">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent font-medium text-sm sm:text-base"
                />
              </div>
              <button
                onClick={handleResetPassword}
                disabled={isSendingReset}
                className="w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-amber-300 py-3 sm:py-4 rounded-xl font-black text-base sm:text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 disabled:opacity-50"
              >
                {isSendingReset ? (
          ...
          {!isSignIn && !showReset && (
            <div className="mt-6 p-4 bg-gradient-to-r from-amber-50 to-yellow-50 rounded-xl border border-amber-200">
              <h3 className="font-bold text-gray-900 mb-2 text-sm sm:text-base">🎁 Waitlist Perks:</h3>
